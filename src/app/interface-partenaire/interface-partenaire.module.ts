...
import { InterfacePartenaireRoutingModule } from './interface-partenaire-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    InterfacePartenaireRoutingModule,DropdownModule,FormsModule,ReactiveFormsModule,TagModule,ConfirmPopupModule,DataViewModule,FieldsetModule,TabViewModule,AccordionModule,MultiSelectModule,
...
export class InterfacePartenaireModule { }
