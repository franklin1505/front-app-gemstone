...
import { InterfaceChauffeurRoutingModule } from './interface-chauffeur-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    InterfaceChauffeurRoutingModule,DropdownModule,FormsModule,ReactiveFormsModule,TagModule,ConfirmPopupModule,DataViewModule,FieldsetModule,TabViewModule,AccordionModule,MultiSelectModule,
...
export class InterfaceChauffeurModule { }
