...
@Component({
  selector: 'app-chauffeurs-externes',
  templateUrl: './chauffeurs-externes.component.html',
  styleUrls: ['./chauffeurs-externes.component.css']
})
export class ChauffeursExternesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.breadcrumbItems.push({ label: 'Chauffeurs Externes' });
    this.getChauffeurs()

  }

  getChauffeurs() {
    this._gveService.getChauffeursByExpression('all_externals').subscribe((data) => {
